<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="StudentTracker.Account.Login" Async="true" meta:resourcekey="PageResource1" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4><asp:Literal runat="server" ID="LogInHeader" Text="Use a local account to log in." meta:resourcekey="LogInHeaderResource1"></asp:Literal></h4>
                    <hr />
                ...
                <p>
                    ...
                    <asp:Literal ID="localAccountTip" runat="server" meta:resourcekey="LocalAccountTipResource" Text="if you don't have a local account."></asp:Literal>
                </p>
            </section>
        </div>
